...
class TestSanitizer:
    ...
    @pytest.fixture
    def sanitizer(self) -> Iterator[Sanitizer]:
        yield Sanitizer()

    def test_clean_text_unchanged(self, sanitizer: Sanitizer) -> None:
    ...
    def test_jailbreak_sanitized(self, sanitizer: Sanitizer) -> None:
    ...
    def test_strict_mode_blocks(self, sanitizer: Sanitizer) -> None:
    ...
    def test_permissive_mode_passes(self, sanitizer: Sanitizer) -> None:
    ...
    def test_custom_patterns(self, sanitizer: Sanitizer) -> None:
    ...
    def test_escape_triggers(self, sanitizer: Sanitizer) -> None:
