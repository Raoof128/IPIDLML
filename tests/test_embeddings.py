...
class TestEmbeddingEngine:
    ...
    def test_fallback_encoding(self, engine):
        ...
        with patch('backend.utils.embeddings.EmbeddingEngine.st_available', new_callable=PropertyMock) as mock_avail:
    ...
    def test_real_model_loading(self, engine):
        ...
        with patch.dict(sys.modules, {'sentence_transformers': mock_module}):
            with patch('backend.utils.embeddings.EmbeddingEngine.st_available', new_callable=PropertyMock) as mock_avail:
                ...
                mock_module.SentenceTransformer.return_value.encode.return_value = np.array([0.1] * 384)
