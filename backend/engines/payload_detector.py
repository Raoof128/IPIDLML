...
class PayloadDetector:
    ...
    def detect(self, text: str, ocr_text: Optional[str] = None, visual_features: Optional[dict] = None) -> Dict[str, Any]:
        """
    ...
    def _empty_result(self) -> Dict[str, Any]:
        ...
        return {
            "injection_score": 0.0,
            "flagged_segments": [],
            "breakdown": {"pattern_score": 0, "bert_score": 0, "embedding_score": 0, "anomaly_score": 0},
            "confidence_scores": {},
            "ml_enabled": bool(self.use_bert and ml_ready)
        }
    ...
    def _pattern_detection(self, text: str) -> Dict[str, Any]:
        ...
        for patterns, ptype in pattern_groups:
            for pattern, weight in patterns:
                # Security: Limit regex execution time/complexity if possible (re module doesn't support timeout natively)
